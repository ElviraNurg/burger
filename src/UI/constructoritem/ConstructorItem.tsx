...
import { deleteItem } from '../../store/constructor/constroctorSlice';
...
const ConstructorItem = ({ item, index }: IConstructorItemProps,) => {
    ...
    return (
        <li ref={item.type !== 'bun' ? ref : null}
            ...
            onClick={onClickItem}
            className={`${styles.constructor__item}  ${itemSwipe ? styles.constructor__item_swipe : ''}`} >
            {item.type === 'bun' ?
                <button className={styles.constructor__nav_none}></button>
